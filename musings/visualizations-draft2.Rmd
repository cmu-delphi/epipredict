...
`covidcast` has other packages. Note that some ofthese packages can be rather
large, meaning that the downloads may fail if the default timeout of 60 seconds
is left unchanges.
...
# Use `force=TRUE` if needed for the downloads below:
