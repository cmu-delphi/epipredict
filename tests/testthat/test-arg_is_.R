...
test_that("logical", {
  ...
  expect_error(arg_is_lgl(l, ll, n))
  expect_error(arg_is_lgl(x))
  expect_silent(arg_is_lgl(l, ll, n, allow_null = TRUE))
  expect_error(arg_is_lgl(l, ll, nn))
...
test_that("scalar", {
  ...
  expect_error(arg_is_scalar(x, y, n))
  expect_silent(arg_is_scalar(x, y, n, allow_null = TRUE))
  expect_error(arg_is_scalar(x, y, nn))
  expect_silent(arg_is_scalar(x, y, nn, allow_na = TRUE))
  expect_error(arg_is_scalar(v, nn))
  expect_error(arg_is_scalar(v, nn, allow_na = TRUE))
  expect_error(arg_is_scalar(v, n, allow_null = TRUE))
  expect_error(arg_is_scalar(nnn, allow_na = TRUE))
})
...
test_that("numeric", {
  ...
  expect_error(arg_is_numeric(i, j, n))
  expect_error(arg_is_numeric(i, nn))
...
test_that("positive", {
  ...
  expect_error(arg_is_pos(i, j, n))
  expect_error(arg_is_pos(i, nn))
  expect_error(arg_is_pos(a = 0:10))
})
...
test_that("nonneg", {
  ...
  expect_error(arg_is_nonneg(i, j, n))
  expect_error(arg_is_nonneg(i, nn))
  expect_silent(arg_is_nonneg(a = 0:10))
})


test_that("nonneg-int", {
  expect_error(arg_is_nonneg_int(a))
  expect_error(arg_is_nonneg_int(d))
  expect_silent(arg_is_nonneg_int(i, j))
  expect_silent(arg_is_nonneg_int(c(i, j)))
  expect_error(arg_is_nonneg_int(i, k))
  expect_silent(arg_is_nonneg_int(i, j, n, allow_null = TRUE))
  expect_error(arg_is_nonneg_int(i, j, n))
  expect_error(arg_is_nonneg_int(i, nn))
...
test_that("probabilities", {
  ...
  expect_error(arg_is_probabilities(a))
  expect_error(arg_is_probabilities(d))
  expect_silent(arg_is_probabilities(c(.4, .7)))
  expect_error(arg_is_probabilities(i, 1.1))
  expect_silent(arg_is_probabilities(c(.4, .8), n, allow_null = TRUE))
  expect_error(arg_is_probabilities(c(.4, .8), n))
  expect_error(arg_is_probabilities(c(.4, .8), nn))
})
...
test_that("chr", {
  ...
  expect_error(arg_is_chr(a, b, n))
  expect_error(arg_is_chr(a, b, nn))
  expect_silent(arg_is_chr(a, b, n, allow_null = TRUE))
  expect_silent(arg_is_chr(a, b, nn, allow_na = TRUE))
  expect_error(arg_is_chr(d))
  expect_error(arg_is_chr(v))
  expect_error(arg_is_chr(ll))
  expect_error(arg_is_chr(z = character(0)))
  expect_silent(arg_is_chr(z = character(0), allow_empty = TRUE))
})

test_that("function", {
  expect_silent(arg_is_function(f, g, parsnip::linear_reg))
  expect_error(arg_is_function(c(a, b)))
  expect_error(arg_is_function(c(f, g)))
...
test_that("coerce scalar to date", {
  ...
  expect_error(arg_to_date(c("12345", "12345")))
})
