...
Code to obtain the full data and subset it as we 
just described is available in `vignettes/panel-data-gemploy.R`.
...
gemploy <- readRDS("gemploy.rds")
grad_employ_subset <- gemploy %>%
  as_epi_df(additional_metadata = c(other_keys = list("age_group", "edu_qual")))
```
