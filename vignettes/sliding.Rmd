...
### Example using CLI and case data from all US states 
...
fc <- bind_rows(
  map_dfr(c(7,14,21,28), ~ k_week_ahead(.x, epi_df = x_latest, outcome = "case_rate", 
...
# Generate the forecasts, and bind them together
can_fc <- bind_rows(
  map_dfr(c(7,14,21,28), ~ k_week_ahead(.x, epi_df = x_latest, outcome = "cr_7dav", 
                                        predictors = "cr_7dav", 
                                        engine = "linear_reg()")),
  map_dfr(c(7,14,21,28), ~ k_week_ahead(.x, epi_df = x_latest, outcome = "cr_7dav", 
                                        predictors = "cr_7dav", 
...
### Example using case data from all US states 
