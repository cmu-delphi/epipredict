...
or extract the entire distribution into a "long" `epi_df` with `quantile_level`
being the probability and `value` being the value associated to that quantile
(each prefixed with the original column name `.pred_distn`).
