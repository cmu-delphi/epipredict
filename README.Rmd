...
up-to-date versions of this could be downloaded with the [`{epidata}` package]() and processed using [`{epiprocess}`]().
...
[^1]: The warning displayed above is because our built-in data was downloaded in May of 2022 whereas we're producing a forecast for January of 2022. This is a retrospective forecast and should not be construed to mimic real-time performance.
